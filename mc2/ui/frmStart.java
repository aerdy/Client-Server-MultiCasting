...
public class frmStart extends javax.swing.JFrame {
    ...
    private void btOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOKActionPerformed
        ...
        if(ltChans.getSelectedValue()==null && !GetCreateNewChannel()){
            JOptionPane.showMessageDialog(this,"You must select a channel to join or create a new one","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        JDialog jWait=new JDialog(this,"Wait... Checking nick and channel availability");
        ...
        if(GetCreateNewChannel()){
            if(ChanAvail){
                ...
                JOptionPane.showMessageDialog(this,"Channel already exists","Error",JOptionPane.ERROR_MESSAGE);       
        }
        else{
